...
**Technologies:** Next.js, TypeScript, React, Tailwind CSS, Radix UI, Framer Motion, WebSocket, Context API, LLMs
...
**Technologies:** TypeScript, Next.js, React, ethers.js, wagmi, RainbowKit, WalletConnect, Stripe, Web3
